...
$(function() {
    ...
    function show_unit(unit_id) {
        function unit_action(method) {
            if (cur_unit) {
                systemd_manager.call(method, [ cur_unit_id, "fail" ])
                        .fail(function(error) {
        ...
        function unit_file_action(method, force) {
            if (cur_unit) {
        ...
        function render() {
            ReactDOM.render(
                React.createElement(ServiceDetails, {
                    ...
                    actionCallback: unit_action,
                    fileActionCallback: unit_file_action,
                    isValid: is_valid,
                }),
